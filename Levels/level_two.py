...
async def Level(): ### TODO - MAKE A LEVEL TWO DESIGN
    platforms = [
        Platform(0, GlobalVariables.Height - 20, GlobalVariables.Width, 20, False, 0),
        Platform(0, GlobalVariables.Height - 200, 20, 180, True, 0),
        Platform(630, 200, 20, 210, True, 0),
        Platform(500, GlobalVariables.Height/2 + 50, 150, 20, False, 1),
        Platform(0, 0, 20, 210, True, 0),
        Platform(0, 210, 150, 20, False, 1),
        Platform(800, 200, 20, GlobalVariables.Height - 220, False, 1),
        Platform(GlobalVariables.Width - 20, 100, 20, 180, True, 0),
    ]
    ...
    while running:
        ...
        if not players[0].completed and door.try_exit(players[0], pressed_keys):
            ...
            Timer.stop_timer()
            GlobalVariables.complete_level(2, Timer.elapsed_time // 1000)
